...
cat <(crontab -l) <(echo "5 0 * * * /home/{{ target_user }}/raspberry-noaa-v3/scripts/tools/db_backup.sh") | crontab -
```
...
```bash
cp /home/{{ target_user }}/raspberry-noaa-v3/db_backups/panel.db.20210212.backup /home/{{ target_user }}/raspberry-noaa-v3/db/panel.db
```
